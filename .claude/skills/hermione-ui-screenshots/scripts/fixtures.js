  ...
  const overview = {
    exercises: [
      {
        ...
        students: [
          { student: 'Ada Lovelace', file: 'src/list.c', exercise: 'ex01-pointers',
            ...
            struggle: 'help', struggleReasons: ['27 min on one file', 'many failing compiles'],
          ...
          { student: 'Alan Turing', file: 'src/main.c', exercise: 'ex01-pointers',
            ...
            struggle: null, struggleReasons: [], terminalSessionId: 's3', studentSource: 'github' },
    ...
    noExercise: [
      { student: 'Tim Berners-Lee', file: '~/.bashrc', exercise: null,
        ...
        struggle: null, struggleReasons: [], terminalSessionId: 's14', studentSource: 'github' },
      { student: 'Radia Perlman', file: null, exercise: null,
        status: 'idle', secondsOnExercise: 60, lastSeenUnixMs: mins(9),
        struggle: null, struggleReasons: [], terminalSessionId: null, studentSource: 'github' },
    ],
  };
