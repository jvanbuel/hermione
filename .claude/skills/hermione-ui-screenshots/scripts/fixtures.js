...
function buildFixtures(now) {
  ...
  const studentFile = {
    ...
    snapshot: {
      ...
      dirty: true,
      content: openBuffer,
      // What crates/server/src/highlight.rs emits for this file: one list of
      // [class, text] spans per line, generated with the real highlighter so
      // the screenshots show what ships.
      highlight: [
